 ...
 */
public class SmallAwesomeRerankerTester {
    ...
    public static void main(String[] args) {
        ...
        edu.berkeley.nlp.assignments.rerank.ParsingRerankerTester.RerankerType rerankerType = edu.berkeley.nlp.assignments.rerank.ParsingRerankerTester.RerankerType.BASIC;

        if (argMap.containsKey("-rerankerType")) {
            rerankerType = edu.berkeley.nlp.assignments.rerank.ParsingRerankerTester.RerankerType.valueOf(argMap.get("-rerankerType"));
        }
