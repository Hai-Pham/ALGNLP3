 ...
 */
public class Zero1FeatureExtractor extends NaiveFeatureExtractor {
...
//                    }
    ...
    public List<Datum> simplyExtractFeatures(Iterable<Pair<KbestList, Tree<String>>> kbestListsAndGoldTrees,
        ...
        while (iterator.hasNext()) {
            ...
            boolean[] zeroOneLosses = new boolean[listTreeFromKbestList.size()];
            ...
            for (Tree<String> t : listTreeFromKbestList) {
                ...
                if (t.toString().equals(goldTree.toString())) {
                    ...
                    zeroOneLosses[idx] = true;
                } else {
                    zeroOneLosses[idx] = false;
                }
            }
            ...
            // update master list
            totalFeaturesWithLabels.add(new Datum(kbestListFeatures, goldTreeFeatures, zeroOneLosses));
